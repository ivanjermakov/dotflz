...
class TestParser(unittest.TestCase):
    ...
    def test_parse_config_4(self):
        config = parse_config(get_config_path(4))
        item = config.items[0]
        self.assertEqual('a/', item.to)

    def test_parse_config_5(self):
        config = parse_config(get_config_path(5))
        item = config.items[0]
    ...
    def test_parse_config_6(self):
        config = parse_config(get_config_path(6))
    ...
    def test_parse_config_7(self):
        config = parse_config(get_config_path(7))
